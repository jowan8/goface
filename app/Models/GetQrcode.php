...
class GetQrcode{
     ...
     * 获取用户小程序码
     * @param   $u_id    in   [ 用户id ]
     * @param   $image_photo   string   [ 用户形象照 ]
     * return json
     */
    public function get_Qrcodeimg( $u_id,$image_photo ){
...
//请求微信，获取小程序二维码
        ...
        //把图片变为正方形
        $square_img = $this->square($image_photo);

//        $avatar = file_get_contents($square_img);//获取图片内容
