...
//上传图片
Route::group(['namespace'=>'Upload','middleware'=>['checkToken']],function(){
    Route::any('upload_file',['uses'=>'UploadController@upload_file']); //上传文件
});

//用户
Route::group(['namespace'=>'Upload','middleware'=>['noCheckToken']],function(){
    Route::any('login',['uses'=>'LoginController@login']); //用户登录
});
