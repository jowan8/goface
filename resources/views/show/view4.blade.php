...
// 	}
    ...
    function linearTween    /* simple linear tweening    */ (t, b, c, d = 1) { return c * t / d + b; }
    function easeInQuad     /* quadratic   easing in     */ (t, b, c, d = 1) { t /= d; return c * t * t + b; }
    function easeOutQuad    /* quadratic   easing out    */ (t, b, c, d = 1) { t /= d; return -c * t * (t - 2) + b; }
    function easeInOutQuad  /* quadratic   easing in/out */ (t, b, c, d = 1) { t /= d * 0.5; if(t < 1) return c * 0.5 * t * t + b; t--; return -c * 0.5 * (t * (t - 2) - 1) + b; }
    function easeInCubic    /* cubic       easing in     */ (t, b, c, d = 1) { t /= d; return c * t * t * t + b; }
    function easeOutCubic   /* cubic       easing out    */ (t, b, c, d = 1) { t /= d; t--; return c * (t * t * t + 1) + b; }
    function easeInOutCubic /* cubic       easing in/out */ (t, b, c, d = 1) { t /= d * 0.5; if(t < 1) return c * 0.5 * t * t * t + b; t -= 2; return c * 0.5 * (t * t * t + 2) + b; }
    function easeInQuart    /* quartic     easing in     */ (t, b, c, d = 1) { t /= d; return c * t * t * t * t + b; }
    function easeOutQuart   /* quartic     easing out    */ (t, b, c, d = 1) { t /= d; t--; return -c * (t * t * t * t - 1) + b; }
    function easeInOutQuart /* quartic     easing in/out */ (t, b, c, d = 1) { t /= d * 0.5; if(t < 1) return c * 0.5 * t * t * t * t + b; t -= 2; return -c * 0.5 * (t * t * t * t - 2) + b; }
    function easeInQuint    /* quintic     easing in     */ (t, b, c, d = 1) { t /= d; return c * t * t * t * t * t + b; }
    function easeOutQuint   /* quintic     easing out    */ (t, b, c, d = 1) { t /= d; t--; return c * (t * t * t * t * t + 1) + b; }
    function easeInOutQuint /* quintic     easing in/out */ (t, b, c, d = 1) { t /= d * 0.5; if(t < 1) return c * 0.5 * t * t * t * t * t + b; t -= 2; return c * 0.5 * (t * t * t * t * t + 2) + b; }
    function easeInSine     /* sinusoidal  easing in     */ (t, b, c, d = 1) { return -c * cos(t / d * HALF_PI) + c + b; }
    function easeOutSine    /* sinusoidal  easing out    */ (t, b, c, d = 1) { return c * sin(t / d * HALF_PI) + b; }
    function easeInOutSine  /* sinusoidal  easing in/out */ (t, b, c, d = 1) { return -c * 0.5 * (cos(PI * t / d) - 1) + b; }
    function easeInExpo     /* exponential easing in     */ (t, b, c, d = 1) { return c * pow(2, 10 * (t / d - 1)) + b; }
    function easeOutExpo    /* exponential easing out    */ (t, b, c, d = 1) { return c * (-pow(2, -10 * t / d ) + 1) + b; }
    function easeInOutExpo  /* exponential easing in/out */ (t, b, c, d = 1) { t /= d * 0.5; if(t < 1) return c * 0.5 * pow(2, 10 * (t - 1)) + b; t--; return c * 0.5 * (-pow(2, -10 * t) + 2) + b; }
    function easeInCirc     /* circular    easing in     */ (t, b, c, d = 1) { t /= d; return -c * (sqrt(1 - t * t) - 1) + b; }
    function easeOutCirc    /* circular    easing out    */ (t, b, c, d = 1) { t /= d; t--; return c * sqrt(1 - t * t) + b; }
    function easeInOutCirc  /* circular    easing in/out */ (t, b, c, d = 1) { t /= d * 0.5; if(t < 1) return -c * 0.5 * (sqrt(1 - t * t) - 1) + b; t -= 2; return c * 0.5 * (sqrt(1 - t * t) + 1) + b; }
